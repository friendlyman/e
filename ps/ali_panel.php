...
while ($row = mysql_fetch_assoc($result)) {
   ...
   // echo $row["imgsrc"];
    //echo $row["label"];
	$html .="<li data-icon=false><a href='#' id=".$row["idname"]."><img src='http://30.10.1.192/elpproject/image/".$row["imgsrc"].".png'><h3>".$row["label"]."</h3></a></li>";
...
$html .= "</a>";
$html .= "</li>"; */ 
echo utf8_encode ("<div class='panel-list'>".$html."</div>");
?>