...
<div data-role="header" id="subheader" data-theme="d">
    ...
    <div class="ui-block-b"><div class="ui-bar ui-bar-b" style="height:20px;text-align: center"><h1>Reviewed Assignments</h1></div></div>
...
<!--                <div id="tabContent" style="margin-left: 0%;margin-right: 5%;">-->
      ...
      <tbody>
        <tr>
            <td><img src='../image/Student Page/stuIcon.png' height="80px" width="70px"></td>
          <td>Allen</td>
         <td>&nbsp;&nbsp;1</td>
         <td>&nbsp;&nbsp;A</td>
    <td>15/Oct/2013</td>
          ...
          <td>
              <a href="../teacher/CheckAssignment.php" data-role="button" data-icon='arrow-r' data-theme="e" data-transition="flow"  data-inline="true" data-mini="true">Check</a>
          </td>
         
        </tr>
       <tr>
            <th><img src='../image/Student Page/stuIcon.png' height="80px" width="70px"></th>
          <td>John</td>
         <td>&nbsp;&nbsp;1</td>
         <td>&nbsp;&nbsp;A</td>
          <td>15/Oct/2013</td>
          ...
          <td>
              <a href="#" data-role="button" data-transition="flow" data-icon='arrow-r' data-theme="e"  data-inline="true" data-mini="true">Check</a>
          </td>
