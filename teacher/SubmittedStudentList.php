...
<div data-role="header" id="subheader" data-theme="d">
    ...
    <div class="ui-block-b"><div class="ui-bar ui-bar-b" style="height:20px;text-align: center"><h1>Submissions</h1></div></div>
      ...
      <thead>
        <tr>
          ...
          <th data-priority="persist">Section</th>
           <th data-priority="persist">Due Date</th>
          <th data-priority="3"><abbr title="Rotten Tomato Rating">Submitted Date</abbr></th>
      ...
      <tbody>
        <tr>
         ...
         <td>&nbsp;&nbsp;1</td>
          ...
          <td>+2days</td>
          <td>
<!--              <a href="#" data-role="button" data-icon='arrow-r'  data-inline="true" data-theme="e" data-mini="true">More</a>-->
          </td>
       ...
       <tr>
         ...
         <td>&nbsp;&nbsp;1</td>
          ...
          <td>+1 day</td>
          <td>
<!--              <a href="#" data-role="button" data-icon='arrow-r' data-theme="e"  data-inline="true" data-mini="true">More</a>-->
          </td>
